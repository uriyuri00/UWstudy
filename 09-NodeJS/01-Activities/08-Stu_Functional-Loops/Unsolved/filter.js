...
// A filter runs through orifinalArray and uses the isPrime function to check if each number is prime. it creates and returns a new array that includes all prime numbers.
const primeArray = originalArray.filter(isPrime);


// TODO: Describe how filter is working in this example. What will the value of moreThan5Array be? 
// A fillter runs throung originalArray and creates a new array containing only the number larger than 5.
